...

{
  ...
  beancount = buildGrammar {
    language = "beancount";
    version = "0.0.0+rev=b2c12eb";
    src = fetchFromGitHub {
      owner = "polarmutex";
      repo = "tree-sitter-beancount";
      rev = "b2c12eb49e308f33312269da1e31469f40c7b3c1";
      hash = "sha256-y8f0IOyRS4IiDJv0CDOoETHQaISS+uWq0DHKSwLvxgw=";
    };
  ...
  requirements = buildGrammar {
    ...
    version = "0.0.0+rev=2764b6b";
    src = fetchFromGitHub {
      owner = "ObserverOfTime";
      repo = "tree-sitter-requirements";
      rev = "2764b6b219b2576577b0ce55c27e9d772e6f64c2";
      hash = "sha256-chh3dHHlOaDFp0EA4UgQs3btLsron3Vc92ZVyvoj6fI=";
    };
  ...
  wing = buildGrammar {
    language = "wing";
    version = "0.0.0+rev=1fc9b78";
    src = fetchFromGitHub {
      owner = "winglang";
      repo = "wing";
      rev = "1fc9b789267f751ec7a9163882da3aa786a45798";
      hash = "sha256-RhYRoOyPxa3xT3ttJzUyLcsdjrDPCRhL5jdyA6bvVzs=";
    };
